...
export const SetupPassword = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const data = await ahrnApi.setupPassword(token, password);
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden text-slate-900">
                ...
                >
                    ...
                    <h1 className="text-3xl font-serif font-bold text-slate-900 mb-4">Account Activated!</h1>
                    <p className="text-slate-600 mb-6">Your password has been set successfully. Redirecting to your dashboard...</p>
                </motion.div>
            </div>
        );
    }
            ...
            >
                <div className="space-y-10">
                    <div className="text-center">
                        ...
                        <h1 className="text-4xl font-serif font-bold text-slate-900 mb-2 tracking-tight">Set Up Your Account</h1>
                        <p className="text-slate-500 text-sm">Create a secure password to activate your technician account</p>
                    </div>
